...
export function CreativePreviewGallery({ items }: CreativePreviewGalleryProps): React.ReactElement {
  ...
  return (
    <div className="flex flex-col gap-6" data-testid="creative-preview-gallery">
      {/* Controls Bar */}
