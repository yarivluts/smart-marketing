...
Working rules for any agent in this repo (Codex / ChatGPT Code, and any tool that reads
`AGENTS.md`). They are the same rules for every agent, so they live in one file:
