 ...
 * `13 §E11.1`, formulas from `04 §2`). Registered through the exact same
 * org-scoped Plugin Registry flow (KAN-46) any third-party manifest uses —
 * an org admin pastes this text — rather than this pack being special-cased
 * into the generic registry machinery.
 *
...
registers:
  metrics: [ad_spend, signups, cost_per_signup, cac, conversion_to_paying, mrr, mrr_movements, net_mrr_churn, troi, collected_revenue, failed_charge_rate]
`.trim();
